...
if (despesa.validarDados()){
      ...
      $('#modalRegistrarDespesa').modal('show')
       document.getElementById("texto1").innerHTML = "Dados cadastrados com sucesso!"
       ...
       valor.value = '' 
        ...
        $('#modalRegistrarDespesa').modal('show')
        document.getElementById("texto1").innerHTML = "Falha campo obrigatorio não preenchido!"
